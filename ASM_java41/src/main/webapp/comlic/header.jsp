            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <a href="index.jsp" class="logo">
                        <img src="https://img5.thuthuatphanmem.vn/uploads/2022/01/16/logo-fpt-fpt-polytechnic-tach-nen-dep_043151037.png" alt="" style="width: 60%"> DiHpG
                    </a>
                    <!-- ***** Logo End ***** -->
                    <!-- ***** Search End ***** -->
                    ...
                    <c:choose>
                    	<c:when test="${not empty sessionScope.CurrenTaikhoan}">
								...
								<li><a
									href="Favorite">Favorite Movie</a></li>
